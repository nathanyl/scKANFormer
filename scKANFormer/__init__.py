...
from . import train, pre, scKANFormer_model
...
def train(adata, gmt_path, project=None,pre_weights='', label_name='Celltype',max_g=300,max_gs=300,mask_ratio =0.015, n_unannotated = 1,batch_size=8, embed_dim=24,depth=2,num_heads=4,lr=0.001, epochs= 10, lrf=0.01):
